# tgbot_just recreated by 1RF4N
A modular telegram Python bot running on python3 with an sqlalchemy database.

Originally a simple group management bot with multiple admin features, it has evolved, becoming extremely modular and 
simple to use.

Can be found on telegram as [꧁☬༒࿈അധോലോക👑ചക്രവർത്തി࿈༒☬꧂](https://t.me/IRFAbot).
...
Alternatively, [find me on telegram](https://t.me/IRFU_IRFA)! (Keep all support questions in the support chat, where more people can help you.)
